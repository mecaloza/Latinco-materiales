...
NfcManager.start();
export default function ScreenPrueba({ navigation, route }) {
  ...
  const handleSaveImage = async () => {
    ...
    if (status === "granted") {
      ...
      console.log("origen", oririgin);
      await MediaLibrary.saveToLibraryAsync(uri);
      if (oririgin === "outs") {
        navigation.navigate("Outs", { image: uri });
      } else {
        navigation.navigate("Ins", { image: uri });
      }
      ...
      {image ? (
        <ViewShot style={styles.fixedRatio} ref={viewShotRef}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.text_info}>
              {oririgin === "outs" ? "Id Salida:" + id : "Id Entrada: " + id}
            </Text>
          </View>
        </ViewShot>
      ) : (
